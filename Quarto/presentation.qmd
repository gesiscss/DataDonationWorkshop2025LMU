...
What you need to code-along:
  ...
  - install all [ChatDashboard Dependencies](https://github.com/gesiscss/ChatDashboard/blob/master/README.md)
  - Download slides, code-along, and example data from corresponding [GitHub Repo](https://github.com/gesiscss/DataDonationWorkshop2025LMU)
